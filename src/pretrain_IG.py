...
def do_InfoGraph(
    node_repr, molecule_repr, batch, criterion, infograph_discriminator_SSL_model
):
...
def train(molecule_model, device, loader, optimizer):
    ...
    print(
        "IG Loss: {:.5f}\tIG Acc: {:.5f}\tTime: {:.3f}".format(
...
if __name__ == "__main__":
    ...
    model_param_group = [
        ...
        {"params": infograph_discriminator_SSL_model.parameters(), "lr": args.lr},
    ]
